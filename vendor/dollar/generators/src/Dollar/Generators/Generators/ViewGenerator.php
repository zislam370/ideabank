...
class ViewGenerator extends Generator {
    ...
    protected function makeTableRows($model)
    {
        ...
        $editAndDelete = <<<EOT
                    <td>
                        <a class="btn btn-primary btn-xs"  href="{{ route('update/{$model}', \${$model}->id) }}"><i class="fa fa-pencil"></i></a>
                        <a class="btn btn-danger btn-xs" href="{{ route('confirm-delete/{$model}', \${$model}->id) }}" data-toggle="modal" data-target="#delete_confirm"><i class="fa fa-trash-o "></i></a>
                    </td>
