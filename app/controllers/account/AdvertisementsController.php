...
class AdvertisementsController extends AuthorizedController {
	...
	public function getIndex()
	{
        ...
        if(!$this->check_access(['advertisements'])){
        ...
        $advertisements = $this->advertisement
            ...
            ->whereRaw(" FIND_IN_SET(workflow_category_id,'$workflow_ids') ")
	...
	public function getCreate()
	{
        ...
        $workflow_categories = Workflow_category::where('is_periodical','=','1')
            ->whereRaw(" FIND_IN_SET(id,'$workflow_ids') ")
            ->lists('name', 'id');
