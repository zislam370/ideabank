...
class Workflow_step_activitiesController extends AdminController {
	...
	public function getCreate($workflowId, $stepId)
	{
        ...
        $group_names =  "'" . implode("','", Group::lists('name')) . "'";
		return View::make('workflow_step_activities.create', compact('workflowId','stepId','activities','groups','group_names','forms'));
	}
	...
	public function postCreate($workflowId, $stepId)
	{
        ...
        if($groups!=null){
            $workflow_step_activity->groups  = implode(',',Input::get('groups'));
        }
...
//        var_dump($selected_forms); return;
        ...
        $groups = Group::lists('name', 'id');
        $group_names =  "'" . implode("','", Group::lists('name')) . "'";
		return View::make('workflow_step_activities.edit', compact('workflow_step_activity','activities','groups','group_names','forms','selected_forms'));
	}
	...
	public function postEdit($id)
	{
        ...
        $workflow_step_activity->groups  = $groups;
