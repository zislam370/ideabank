...
<!--                <li {{ (Request::is('about-us') ? 'class="active"' : '') }}><a href="{{ URL::to('about-us') }}">Discover</a></li>-->
<!--                <li {{ (Request::is('contact-us') ? 'class="active"' : '') }}><a href="{{ URL::to('contact-us') }}">Start</a></li>-->
<!---->
<!--            </ul>-->
...
<!--            <li{{ (Request::is('admin/posts*') ? ' class="active"' : '') }}><a href="{{ URL::to('admin/posts') }}"><i class="icon-list-alt icon-white"></i> Blog Posts</a></li>-->
            ...
            <li {{ (Request::is('auth/signin') ? 'class="active"' : '') }}><a href="{{ route('signin') }}">Log in</a></li>
            @endif
            </ul>
        </div><!--/.nav-collapse -->
    </div>
