    ...
    <div class="top-content-menu">
        ...
        <div id="top-menu" class="collapse in">
            <ul class="list-unstyled ">
                <li class="active"><a href="index.html">@lang('form/title.Home')</a></li>
                <li class=""><a href="ui.html">@lang('form/title.User_Interface')</a></li>
                <li class=""><a href="form_elements.html">@lang('form/title.Form_Elements')</a></li>
                <li class=""><a href="tables.html">@lang('form/title.Tables')</a></li>
                <li class=""><a href="maps_google.html ">@lang('form/title.Maps')</a></li>
                <li class=""><a href="typography.html">@lang('form/title.Typography')</a></li>
            </ul>
        </div>
    </div>
    <br/>
...
<script src="{{ asset('backend_assets_new/components/forms_elements_bootstrap-datepicker/bootstrap-datepicker.init.js?v=v1.0.0-rc1&amp;sv=v0.0.1.2') }}"></script>
...
<script src="{{ asset('backend_assets_new/plugins/forms_editors_wysihtml5/js/wysihtml5-0.3.0_rc2.min.js?v=v1.0.0-rc1&amp;sv=v0.0.1.2') }}"></script>
<script src="{{ asset('backend_assets_new/plugins/forms_editors_wysihtml5/js/bootstrap-wysihtml5-0.0.2.js?v=v1.0.0-rc1&amp;sv=v0.0.1.2') }}"></script>
<script src="{{ asset('backend_assets_new/components/forms_editors_wysihtml5/wysihtml5.init.js?v=v1.0.0-rc1&amp;sv=v0.0.1.2') }}"></script>
