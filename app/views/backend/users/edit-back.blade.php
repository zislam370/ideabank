        ...
        <div class=" form">
            ...
            <form class="apply-nolazy form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group {{ $errors->first('email', 'has-error') }}">
                    ...
                    <div class="col-sm-5">
                        <input type="email" id="email" name="email" class="form-control" placeholder="{{Lang::get('admin/users/form.email')}}" value="{{{ Input::old('email', $user->email) }}}">
                ...
                <!--                        <div class="col-sm-5">-->
                <!--                            <input type="password" id="password_confirm" name="password_confirm" class="form-control" placeholder="{{Lang::get('admin/users/form.confirmpassword')}}" value="{{{ Input::old('password_confirm') }}}">-->
                ...
                <!--                    <div class="col-sm-5">-->
                <!--                        <input type="text" id="mobile" name="mobile" class="form-control" data-mask="99999999999" value="{{{ Input::old('mobile', $user->mobile) }}}">-->
