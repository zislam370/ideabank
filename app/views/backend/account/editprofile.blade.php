...
<section class="well">
    ...
    <div class="pull-right">
        <a href="{{ route('user/profile',$user->id) }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> @lang('button.back')</a>
        <a href="{{ route('update/user',$user->id) }}" class="btn btn-small btn-success"><i class="icon-circle-arrow-left icon-white"></i> @lang('button.role_edit')</a>
    </div>
    <div class="separator"></div>
    <div class="panel-body">
        <div class=" form">
            <form class="apply-nolazy form-horizontal" role="form" method="post" action="" autocomplete="off" enctype="multipart/form-data">
                <!-- CSRF Token -->
                <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                <!-- First Name -->
                <div class="form-group {{ $errors->first('first_name', 'has-error') }}">
                    <label for="first_name" class="col-sm-3 control-label">@lang('form/title.name')</label>
                        <div class="col-sm-5">
                ...
                <div class="form-group {{ $errors->first('email', 'has-error') }}">
                    ...
                    <div class="col-sm-5">
                        <input type="email" id="email" name="email" class="form-control" placeholder="{{Lang::get('account/form.email')}}" value="{{{ Input::old('email', $user->email) }}}">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group {{ $errors->first('area_id', 'has-error') }}">
                    ...
                    <label for="area_id" class="col-sm-3">Location @lang('form/title.area')</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group {{ $errors->first('office_id', 'has-error') }}">
                    ...
                    <label for="office_id" class="col-sm-3">Office @lang('form/title.office')</label>
                    <div class="col-sm-6">
                        <div class="input-group">
