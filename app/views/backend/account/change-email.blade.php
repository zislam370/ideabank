...
<form class="apply-nolazy form-horizontal" role="form" method="post" action="" autocomplete="off">
    ...
    <div class="form-group {{ $errors->first('email', 'has-error') }}">
        <label for="email" class="col-sm-3 control-label">@lang('account/form.newemail')<span class="text-danger">*</span></label>
            <div class="col-sm-5">
    ...
    <div class="form-group {{ $errors->first('email_confirm', 'has-error') }}">
        <label for="email" class="col-sm-3 control-label">@lang('account/form.confirmemail')<span class="text-danger">*</span></label>
            <div class="col-sm-5">
