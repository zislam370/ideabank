<form autocomplete="off" method="post" action="{{ route('form_richtexts',$activity->id) }}"
      class="form margin-none" novalidate="novalidate">
    <!-- CSRF Token -->
    ...
    <div class="form-group">
        {{ Form::textarea('body', Input::old('body'), array('class'=>'ckeditor form-control', 'placeholder'=>Lang::get('form/title.Content'))) }}
    </div>
