...
<h1>
    ...
    <div class="pull-right">
        <a href="{{ route('create/workflow_step_activity') }}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
    </div>
</h1>
@stop
...
<div class="widget">
    ...
    <div class="widget-body innerAll inner-2x">
        ...
        @if ($workflow_step_activities->count() >= 1)
        ...
        {{ $workflow_step_activities->links() }}
    </div>
</div>
