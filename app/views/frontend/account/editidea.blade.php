        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                ...
                <div style="width: 72.667%;" class="col-sm-8">
                    <input id="idea_name" type="text" name="name" class="form-control" value="{{{Input::old('name',$idea->name)}}}">
            ...
            <div class="form-group {{ $errors->first('prob_stmnt', 'has-error') }}">
                ...
                <div style="width: 72.667%;" class="col-sm-8">
                    ...
                    {{ Form::textarea('prob_stmnt', Input::old('prob_stmnt',$idea->prob_stmnt), array('id'=>'prob_stmnt','class'=>'ckeditor form-control')) }}
            ...
            <div class="form-group {{ $errors->first('sol_stmnt', 'has-error') }}">
                ...
                <div style="width: 72.667%;" class="col-sm-8">
                    ...
                    {{ Form::textarea('sol_stmnt', Input::old('sol_stmnt',$idea->sol_stmnt), array('id'=>'sol_stmnt', 'class'=>'ckeditor form-control')) }}
            ...
            <div class="form-group {{ $errors->first('duration', 'has-error') }}">
                ...
                <div class="col-sm-2">
                    <input id="duration" onkeypress="return isNumber(event)" type="text" name="duration" class="form-control" value="{{{Input::old('duration',$idea->duration)}}}">
            ...
            <div class="form-group {{ $errors->first('area_id', 'has-error') }}">
                {{ Form::hidden('area_id', $idea->area_id,array('id'=>'area_id')); }}
                ...
                <div  style="width: 72.667%;" class="col-sm-9">
                    <div class="input-group">
                        <input class="form-control" id="area_id_txt" style="width: 100%;" value="{{$idea->area?$idea->area->name:''}}" />
            ...
            <div class="form-group {{ $errors->first('office_id', 'has-error') }}">
                {{ Form::hidden('office_id', $idea->office_id,array('id'=>'office_id')); }}
                <label style="width: 27%;"  for="office_id" class="col-sm-3">Office @lang('form/title.office')</label>
                <div  style="width: 72.667%;" class="col-sm-9">
                    <div class="input-group">
                        <input class="form-control" id="office_id_txt" style="width: 100%;" value="{{$idea->office?$idea->office->name:''}}" />
                        <div class="input-group-btn btn-group dropup">
