...
{{-- Web site Title --}}
@section('title')
@lang('form_deliverables/title.management') ::
@parent
@stop
...
<h1>
    ...
    <div class="pull-right">
        <a href="{{ route('create/form_deliverable') }}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
    </div>
</h1>
@stop
...
<div class="widget">
    ...
    <div class="widget-body innerAll inner-2x">
        ...
        <table class="table table-striped table-advance table-hover">
            ...
            <tbody>
                @foreach ($form_deliverables as $form_deliverable)
                    <tr>
