...
<h1>
    @lang('form_deliverables/title.create')

    <div class="pull-right">
        <a href="{{ route('form_deliverables') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> @lang('button.back')</a>
    </div>
</h1>
@stop
...
<form autocomplete="off" method="post" class="form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="widget-head">
            <h4 class="heading">@lang('form_deliverables/title.create.sub')</h4>
        </div>
        <!-- // Widget heading END -->
        ...
        <div class="form-group">
            ...
            <div class="form-actions">
                <a class="btn btn-link" href="{{ route('form_deliverables') }}">@lang('button.cancel')</a>
