<form autocomplete="off" method="post" action="{{ route('form_budgets',$activity->id) }}"
    ...
    <table id="tbl-budget" class="table table-bordered table-striped table-white">
        <tbody>
        <tr id="0">
            <td class="col-sm-1">
    ...
    <!--<a class="btn btn-info" href="javascript:;" onclick="add_budget_row()">@lang('button.add')</a>-->
