    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                <label for="name" class="col-sm-3 control-label">@lang('ideas/form.name') <span style="color: red">*</span></label>
            ...
            <div class="form-group {{ $errors->first('sectors', 'has-error') }}">
                ...
                <div class="col-sm-5">
                    {{ Form::select('sectors[]', $sectors , Input::old('sectors'), array('id'=>'sectors','multiple'=>'multiple','style'=>'width:100%;')) }}
                </div>
                <div class="col-sm-4">
            ...
            <!-- Sectors -->
            <div class="form-group {{ $errors->first('sectors', 'has-error') }}">
                <label for="sectors" class="col-sm-4">@lang('form/title.sectors')</label>
                <div class="col-sm-8">
