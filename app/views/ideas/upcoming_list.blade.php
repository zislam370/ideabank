...
{{-- Content --}}
@section('content')
<h1 class="pull-left">@lang('form/title.upcoming_ideas')</h1>
            ...
            <div class="widget-body padding-none">
                <div class=" media innerAll overflow-visible margin-none">
                    ...
                    <div class="media-body">
                        <span class="strong"> Change Priority:
                            {{ Form::selectRange('priority', 0, 4,$idea->priority,array('onchange'=>'set_idea_priority('.$idea->id.',this)')) }}
                        </span>
...
<script>
    ...
    function set_idea_priority(id,t){
        var v = $(t).val();
        document.location.href= '/ideas/'+id+'/'+v+'/set_priority';
    }
