...
<h1>
    @lang('idea_step_activities/title.create')

    <div class="pull-right">
        <a href="{{ route('idea_step_activities') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> @lang('button.back')</a>
    </div>
</h1>
@stop
...
<form autocomplete="off" method="post" class="apply-nolazy form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="widget-head">
            <h4 class="heading">@lang('idea_step_activities/title.create.sub')</h4>
        </div>
        <!-- // Widget heading END -->
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            {{ Form::label('idea_step_id', Lang::get('form/title.Idea_step_id'), array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            {{ Form::label('workflow_activity_id', Lang::get('form/title.Workflow_activity_id'), array('class'=>'col-md-2 control-label')) }}
            <div class="col-sm-10">
        ...
        <div class="form-group">
            ...
            <div class="form-actions">
                <a class="btn btn-link" href="{{ route('idea_step_activities') }}">@lang('button.cancel')</a>
