<form autocomplete="off" method="post" action="{{ route('form_times',$activity->id) }}"
    ...
    <table id="tbl-time" class="table table-bordered table-striped table-white">
        <tbody>
        <tr id="0">
            <td class="col-sm-1">
            ...
            <td>
                <table  class="table table-bordered table-condensed">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="item[0][duration]" placeholder="{{Lang::get('form/title.duration')}}"   class="duration  inputmask-integer form-control">
                        </td>
                    </tr><tr>
