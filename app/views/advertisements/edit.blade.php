...
{{-- Page title --}}
@section('title')
@lang('advertisements/title.edit') ::
@parent
@stop
    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {{ Form::select('workflow_category_id', $workflow_categories , Input::old('workflow_category_id', $advertisement->workflow_category_id), array('class'=>'form-control')) }}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                ...
                <div class="col-sm-10">
                    {{ Form::text('name', Input::old('name',$advertisement->name), array('class'=>'form-control', 'placeholder'=>Lang::get('advertisements/form.name'))) }}
            ...
            <div class="form-group {{ $errors->first('location', 'has-error') }}">
                ...
                <div class="col-sm-10">
                    {{ Form::text('location', Input::old('location',$advertisement->location), array('class'=>'form-control', 'placeholder'=>Lang::get('advertisements/form.location'))) }}
        ...
        <div class="form-group {{ $errors->first('link_title', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('link_title', Input::old('link_title',$advertisement->link_title), array('class'=>'form-control', 'placeholder'=>Lang::get('advertisements/form.Link_title'))) }}
        ...
        <div class="form-group {{ $errors->first('start', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('start', Input::old('start',date( 'd-m-Y', strtotime( $advertisement->start ))), array('class'=>'datepicker1 form-control', 'placeholder'=>'dd/mm/yyyy')) }}
        ...
        <div class="form-group {{ $errors->first('end', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('end', Input::old('end',date( 'd-m-Y', strtotime( $advertisement->end ))), array('class'=>'datepicker1 form-control', 'placeholder'=>'dd/mm/yyyy')) }}
            ...
            <div class="form-group {{ $errors->first('advert', 'has-error') }}">
                ...
                <div class="col-sm-10">
                    {{ Form::textarea('advert', Input::old('advert',$advertisement->advert), array('class'=>'ckeditor form-control', 'placeholder'=>Lang::get('advertisements/form.Advert'))) }}
            ...
            <div class="form-group {{ $errors->first('attachment', 'has-error') }}">
                ...
                <div class="col-sm-10">
                    <div class="">
                        <a href="{{ asset($advertisement->attachment->url('original')) }}">{{ $advertisement->attachment->originalFilename()?$advertisement->attachment->originalFilename():""}}</a>
                    </div>
