<form autocomplete="off" method="post" action="{{ route('form_payment_schedules',$activity->id) }}"
    ...
    <table id="tbl-payment_schedule" class="table table-bordered table-striped table-white">
        <tbody>
        <tr id="0">
            <td class="col-sm-1">
