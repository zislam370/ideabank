<form autocomplete="off" method="post" action="{{ route('form_activities',$activity->id) }}"
    ...
    <table id="tbl-activity" class="table table-bordered table-striped table-white">
        <tbody>
        <tr id="0">
            <td class="col-sm-1">
            ...
            <td>
                <table  class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="item[0][plan_start]" placeholder="{{Lang::get('form/title.start_date')}}"   class="plan_start inputmask-date-3 datepicker1 form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>@lang('form/title.end_date')</td>
                        <td>
                            <input type="text" name="item[0][plan_end]" placeholder="{{Lang::get('form/title.end_date')}}"   class="plan_end inputmask-date-3 datepicker1 form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>@lang('form/title.responsible_person')</td>
                        <td>
                            <input type="text" name="item[0][responsible_person]" placeholder="{{Lang::get('form/title.responsible_person')}}"   class="responsible_person form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>@lang('form/title.target_date')</td>
                        <td>
                            <input type="text" name="item[0][target_date]" placeholder="{{Lang::get('form/title.target_date')}}"   class="target_date inputmask-date-3 datepicker1 form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>@lang('form/title.achieved_date')</td>
                        <td>
                            <input type="text" name="item[0][achieved_date]" placeholder="{{Lang::get('form/title.achieved_date')}}"   class="achieved_date inputmask-date-3 datepicker1 form-control">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="item[0][comments]" placeholder="{{Lang::get('form/title.comment')}}"   class="comments form-control">
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <!--<a class="btn btn-info" href="javascript:;" onclick="add_activity_row()">@lang('button.add')</a>-->
