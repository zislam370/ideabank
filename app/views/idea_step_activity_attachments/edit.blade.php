...
{{-- Page title --}}
@section('title')
@lang('idea_step_activity_attachments/title.edit') ::
@parent
@stop
...
<form autocomplete="off" method="post" class="form-horizontal margin-none" novalidate="novalidate" enctype="multipart/form-data">
    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="col-sm-10">
              {{ Form::input('number', 'idea_step_activity_id', Input::old('idea_step_activity_id',$idea_step_activity_attachment->idea_step_activity_id), array('class'=>'form-control')) }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              {{ Form::input('number', 'head_id', Input::old('head_id',$idea_step_activity_attachment->head_id), array('class'=>'form-control')) }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              {{ Form::text('comment', Input::old('comment',$idea_step_activity_attachment->comment), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.comment'))) }}
            </div>
        </div>
