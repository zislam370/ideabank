...
<form autocomplete="off" method="post" class="form-horizontal margin-none" novalidate="novalidate" enctype="multipart/form-data">
    ...
    <div class="widget">
        ...
        <div class="widget-head">
            <h4 class="heading">@lang('front_banners/title.edit.sub')</h4>
        </div>
        <!-- // Widget heading END -->
        ...
        <div class="widget-body innerAll inner-2x">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  {{ Form::input('text', 'title', Input::old('title',$front_banner->title), array('class'=>'form-control')) }}
                </div>
            </div>
             <div class="form-group">
                {{ Form::label('slide_title', Lang::get('form/title.slide_title'), array('class'=>'col-md-2 control-label')) }}
                <div class="col-sm-10">
                  {{ Form::input('text', 'slide_title', Input::old('slide_title',$front_banner->slide_title), array('class'=>'form-control')) }}
                </div>
            </div>
             <div class="form-group {{ $errors->first('img', 'has-error') }}">
                 ...
                 <div class="col-sm-10">
                    <img src="{{$front_banner->img->url('thumb')}}" >
