<form autocomplete="off" method="post" action="{{ route('form_scores',$activity->id) }}"
    ...
    <table id="tbl-score" class="table table-bordered table-striped table-white">
        <tbody>
        <tr id="0">
            <td class="col-sm-1">
            ...
            <td>
                <table  class="table table-bordered table-condensed">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="item[0][score]" placeholder="{{Lang::get('form/title.score')}}"   class="score inputmask-integer form-control">
                        </td>
                    </tr><tr>
                        <td>@lang('form/title.comment')</td>
                        <td>
                            <input type="text" name="item[0][comment]" placeholder="Comment"  class="comment form-control">
                        </td>
                    </tr>
                </table>
            </td>
