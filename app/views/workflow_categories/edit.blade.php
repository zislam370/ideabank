...
{{-- Page title --}}
@section('title')
@lang('workflow_categories/title.edit') ::
@parent
@stop
    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  {{ Form::select('is_periodical', array('1' => Lang::get('form/title.Yes'), '0' => Lang::get('form/title.No')) , Input::old('is_periodical', $workflow_category->is_periodical), array('class'=>'form-control')) }}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {{ Form::select('groups[]', $groups , Input::old('groups',explode(',',$workflow_category->groups)), array('id'=>'groups','multiple'=>'multiple','style'=>'width:100%;')) }}
                </div>
            </div>
            ...
            <div class="form-group {{ $errors->first('name', 'has-error') }}">
                ...
                <div class="col-sm-10">
                  {{ Form::text('name', Input::old('name', $workflow_category->name), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.name'))) }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  {{ Form::textarea('description', Input::old('description', $workflow_category->description), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.description'))) }}
                </div>
            </div>
