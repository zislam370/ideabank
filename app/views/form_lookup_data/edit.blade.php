...
{{-- Page title --}}
@section('title')
@lang('form_lookup_data/title.edit') ::
@parent
@stop
...
<form autocomplete="off" method="post" class="apply-nolazy form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="col-sm-10">
                {{ Form::select('form_lookup_id', $form_lookups , Input::old('form_lookup_id',$form_lookup_datum->form_lookup_id)) }}
            </div>
        </div>
        ...
        <div class="form-group {{ $errors->first('name', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('name', Input::old('name',$form_lookup_datum->name), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.name'))) }}
