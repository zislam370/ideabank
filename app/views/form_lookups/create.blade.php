...
<h1>
    @lang('form_lookups/title.create')
...
<form autocomplete="off" method="post" class="apply-nolazy form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="form-group {{ $errors->first('description', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('description', Input::old('description'), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.description'))) }}
