...
{{-- Page title --}}
@section('title')
@lang('activity_forms/title.edit') ::
@parent
@stop
...
<form autocomplete="off" method="post" class="apply-nolazy form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="widget-body innerAll inner-2x">
            ...
            <div class="col-sm-10">
              {{ Form::text('name', Input::old('name', $activity_form->name), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.name'))) }}
        ...
        <div class="form-group {{ $errors->first('description', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::textarea('description', Input::old('description', $activity_form->description), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.description'))) }}
        ...
        <div class="form-group {{ $errors->first('action_uri', 'has-error') }}">
            ...
            <div class="col-sm-10">
              {{ Form::text('action_uri', Input::old('action_uri', $activity_form->action_uri), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.action_uri'))) }}
