...
<form autocomplete="off" method="post" class="apply-nolazy form-horizontal margin-none" novalidate="novalidate">
    ...
    <div class="widget">
        ...
        <div class="form-group {{ $errors->first('slug', 'has-error') }}">
            ...
            <div class="col-sm-10">
                {{ Form::text('slug', Input::old('slug'), array('class'=>'form-control', 'placeholder'=>Lang::get('form/title.slug'))) }}
        ...
        <div class="form-group {{ $errors->first('body', 'has-error') }}">
            ...
            <div class="col-sm-10">
                {{ Form::textarea('body', Input::old('body'), array('class'=>'ckeditor form-control', 'placeholder'=>Lang::get('form/title.Body'))) }}
                {{ $errors->first('body', '<span class="help-block">:message</span>') }}
            </div>
        </div>
        <div class="form-group {{ $errors->first('meta_title', 'has-error') }}">
            <label for="meta_title" class="col-sm-2 control-label">@lang('pages/form.metatitle')</label>
            <div class="col-sm-10">
        ...
        <div class="form-group {{ $errors->first('meta_description', 'has-error') }}">
            <label for="meta_description" class="col-sm-2 control-label">@lang('pages/form.metadescription')</label>
            <div class="col-sm-10">
        ...
        <div class="form-group {{ $errors->first('meta_keywords', 'has-error') }}">
            <label for="meta_keywords" class="col-sm-2 control-label">@lang('pages/form.metakeywords')</label>
            <div class="col-sm-10">
                <input id="meta_keywords" name="meta_keywords" class="form-control" value="{{{ Input::old('meta_keywords') }}}">
