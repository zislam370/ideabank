...
class Workflow_stepsController extends AuthorizedController {
...
//	    $workflow_steps = $this->workflow_step->where('workflow_id', $workflowId)->orderBy('step_no', 'ASC')->paginate(10);
	...
	public function getCreate($workflowId)
	{
		...
		return View::make('workflow_steps.create', compact('workflowId','steps'));
	}
	...
	public function getEdit($id)
	{
		...
		return View::make('workflow_steps.edit', compact('workflow_step','steps'));
	}
