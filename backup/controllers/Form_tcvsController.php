    ...
    public function postIndex($activity_id){
        ...
        if (empty($form_tcv))
        {
            ...
            foreach($items as $item){
                ...
                $form_item->timeafter = $item['timeafter'];
                $form_item->timebefore = $item['timebefore'];
                $form_item->timebenefit = $item['timebenefit'];
                $form_item->visitafter = $item['visitafter'];
                $form_item->visitbefore = $item['visitbefore'];
                $form_item->visitbenefit = $item['visitbenefit'];
