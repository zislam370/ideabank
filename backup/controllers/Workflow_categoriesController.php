...
class Workflow_categoriesController extends AuthorizedController {
	...
	{
		return View::make('workflow_categories.create');
	}
	...
	public function getEdit($id)
	{
		...
		return View::make('workflow_categories.edit', compact('workflow_category'));
	}
